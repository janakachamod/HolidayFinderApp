...
class FetchCurrentData : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fetch_current_data)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        this.setTitle("Fetch Current Location Data")
        getCalendarData()
    ...
    fun getCalendarData() {
        val url = "https://calendarific.com/api/v2/holidays?api_key=f6740c4eafcdc2a625e5d59965249cf4ec41fca4&country=" + intent.getStringExtra("code") + "&year=" + intent.getStringExtra("year") + ""
